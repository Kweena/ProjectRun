...
Application.TitleScene.prototype = {
	...
	{ 
		...
		this.background.height = Application.Game.world.height;
	 	...
	 	this.start = this.game.add.text(this.game.world.centerX , this.game.world.centerY + 180, "Start", { font: "50px Merriweather", fill: "#E6007E", align: "left" });
		...
		this.load = this.game.add.text(this.game.world.centerX, this.game.world.centerY + 240, "Load", { font: "50px Merriweather", fill: "#808DC1", align: "left" });
		this.load.setShadow(3, 3, 'rgba(0,0,0,0.5)', 5);
		this.load.anchor.x = 0.5;

		this.option = this.game.add.text(this.game.world.centerX, this.game.world.centerY + 300, "Option", { font: "50px Merriweather", fill: "#E6007E", align: "left" });
		...
		this.credit = this.game.add.text(this.game.world.centerX , this.game.world.centerY + 360, "Credit", { font: "50px Merriweather", fill: "#E6007E", align: "left" });
